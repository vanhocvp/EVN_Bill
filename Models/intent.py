...
class INTENT_CLS:
    def __init__(self):
        ...
        self.intent_list = {0:'intent_this_phone', 1:'intent_affirm', 2:'intent_provide_code_customer', 3:'intent_provide_address', 4:'intent_cant_hear', 5:'intent_deny_confirm', 6:'intent_provide_name', 7:'intent_provide_phone_number'}
    ...
    def get_intent(self, mess):
        ...
        res = {'intent':self.intent_list[index], 'score': str(pred[0][index])}
        return res
